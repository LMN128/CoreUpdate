; LnxSpectrum ASM editor (www.ilnx.cz) 01.10.2015
HOOK_BASE	equ	128
MISC_BASE	equ	HOOK_BASE+8
FSYS_BASE	equ	MISC_BASE+16

DISK_STATUS	equ	HOOK_BASE+0	; hookcodes for block devices
...
M_EXECCMD	equ	MISC_BASE+7	; pass in HL pointer to: "command args",0
